...
const containerElement = document.querySelector(".container .row .col");
...
playBtnElement.addEventListener("click", function () {
  gameOver = false;
  generateGameField(containerElement);
});
...
function endGame(score) {
  let message =
    gameOver === false
      ? `you win!!! you scored ${score} points`
      : `BOOOOM, GAME \n OVER!!! you scored ${score} points`;
  alert(message);
}
